    ...
    <div class="container">
        ...
        <header>
            ...
            <div class="sidebar">
                ...
                <a href="edit_accountant.php" class="active">
                    <span class="material-symbols-outlined">person_add_disabled</span>
        ...
        <main>
            <div class="center">
                ...
                <!-- Order Summary DB -->
                 <br>
                <h1><b>Accountant Information</b></h1>
                <div class="edit_employee_info">
                    <form action="../DB/add_accountant.php" method="POST">
                        <table id="acc">
                            ...
                            <?php include '../DB/add_accountant.php'; ?>
                        </table>
                        <button type="submit" class="btn">Add Accountant</button>
                        
                    </form>

                    <form action="../DB/update_accountant.php" method="POST">
                        <table id="acc">
                            <thead class="form-style">
                                <tr>
                                    <td><b>ID:</b></td>
                            ...
                            <?php include '../DB/update_accountant.php'; ?>
                        </table>
                        <button type="submit" class="btn">Update Accountant</button>
                    </form>

                    <form action="../DB/delete_accountant.php" method="POST">
                        <table id="acc">
                            <thead class="form-style">
                                <tr>
                                    <td><b>ID:</b></td>
                            ...
                            <?php include '../DB/delete_accountant.php'; ?>
                        </table>
                    <button type="submit" class="btn">Delete Accountant</button>
                    </form>
                </div>
            </div>
        </main>
